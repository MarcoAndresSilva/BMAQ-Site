...
function Gallery(element) {
  ...
  this.list = [...element.querySelectorAll(".img-especiales")];
  ...
  this.container.addEventListener(
    ...
    function (e) {
      console.log(this);
      // self.openModal();
      if (e.target.classList.contains("img-especiales")) {
...
const reforzadas = new Gallery(getElement(".equipos-especiales"));
